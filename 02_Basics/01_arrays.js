...
// console.log(fruits.splice(1,2, "grapes"));
// console.log(fruits.splice(4,0, "grapes"));
...
// result = numbers.indexOf(6,5);
// console.log(result);

// res = numbers.lastIndexOf(6,5);
// console.log(res);
...
// const results  = numbers.find((element,index,array) => {
//     return element > 5;
// })
// console.log(results);   
...
// const result = numbers.findIndex((element,index,array) => {
//     return element > 4;
// })
// console.log(result);
